...
public class ListMenuAdapter extends BaseAdapter {
	...
	public ListMenuAdapter(Context c, ArrayList<HashMap<String, String>> d) {
		data = d;
		context = c;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View vi = convertView;
		if (convertView == null) {
			vi = inflater.inflate(R.layout.list_category_channel, parent, false);
		}
		HashMap<String, String> m = data.get(position);
		TextView t = (TextView) vi.findViewById(R.id.tCategoryChannel);
