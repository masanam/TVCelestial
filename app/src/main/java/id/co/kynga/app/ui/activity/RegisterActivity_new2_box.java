...
public class RegisterActivity_new2_box extends Activity {
	public static RegisterActivity_new2_box instance;

	private ImageView btnScan0, btnScan;
	...
	protected void onCreate(@Nullable Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_register_new2_box);
		getcountrycode();
		setInitial();
	}
/*
...
*/
		...
		btnScan0=(ImageView)findViewById(R.id.btnScan0);
        ...
        if(response!=null)
        {
            try {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        android.app.AlertDialog.Builder b = new android.app.AlertDialog.Builder(RegisterActivity_new2_box.this);
...
*/
	...
	public void addListenerOnSpinnerItemSelection(){
		...
		spinner1.setOnItemSelectedListener(new SpinnerCustomOnItemSelectedListener2());
	}
