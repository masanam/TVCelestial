...
public class HlsRendererBuilder implements DemoPlayer.RendererBuilder {
	...
	private static final int MAIN_BUFFER_SEGMENTS = 510;
	...
	private static OnPlaylistParsed onPlaylistParsed;
	...
	private static final class AsyncRendererBuilder implements ManifestCallback<HlsPlaylist> {
		...
		public void onSingleManifest(HlsPlaylist manifest) {
			...
			if (manifest instanceof HlsMasterPlaylist) {
				...
				if (onPlaylistParsed != null) {
					onPlaylistParsed.onParsed(masterPlaylist);
				}
			}
	...
	public interface OnPlaylistParsed{
		void onParsed(HlsMasterPlaylist playlist);
	}

	public static void setOnPlaylistParsed(OnPlaylistParsed listener){
		onPlaylistParsed = listener;
	}
}