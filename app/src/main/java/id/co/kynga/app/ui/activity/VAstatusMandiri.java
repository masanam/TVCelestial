...
public class VAstatusMandiri extends Activity {

    private ListView mListView1_1, mListView1_2, mListView1_3, mListView1_3_2, mListView1_4,mListView1_5,mListView1_6,mListView1_7;
    ...
    private static ArrayList<String> daftarBillerCode = new ArrayList<String>();
    private static ArrayList<String> daftarBillKey = new ArrayList<String>();
...
*/
    ...
    public static VAstatusMandiri instance;
...
*/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_va_mandiri);
        ...
        if (!daftarBillerCode.isEmpty()){
            daftarBillerCode.clear();
        }
        if (!daftarBillKey.isEmpty()){
            daftarBillKey.clear();
        }
        ...
        */
        ...
        //for (int i = 0;i< va_model.list.size();i++){
            ...
            if(va_model.list.get(i).bank.contains("mandiri")) {
                daftarPemesanList.add(String.valueOf(intNumber + 1).toString());
                daftarNoHpList.add(va_model.list.get(i).bank);
                daftarBillerCode.add(va_model.list.get(i).payment_code); //Biller Code = va_number
                daftarBillKey.add(va_model.list.get(i).va_number); //Bill Key = payment code
        ...
        mListView1_3_2= (ListView) findViewById(R.id.listView1_3_2);
...
*/
        ...
        mListView1_3.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1,daftarBillerCode));
        mListView1_3_2.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1,daftarBillKey));
...
*/
 ...
 /*
   ...
   */
        ...
        ListUtils.setDynamicHeight(mListView1_3_2);
