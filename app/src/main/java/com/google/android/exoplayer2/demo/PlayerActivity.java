...
public class PlayerActivity extends Activity implements OnClickListener, ExoPlayer.EventListener,
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    if (sharedpreferences.contains(currentPosition)) {
      cpPosition = sharedpreferences.getString(currentPosition, "");
    ...
    */
    ...
    //Additional SHaredPreference
    /*
    pref = PreferenceManager.getDefaultSharedPreferences(PlayerActivity.this);
    table = new Hashtable<>();
    table.put(link, cpPosition);
   // table.put("a", "anita");
   // Log.e("table size", ""+table.size());
    SharedPreferences.Editor edit = pref.edit();
    //edit.putString("hashdata", table.get("r"));
    edit.putString(link, table.get(link));
    edit.commit();
    */
  ...
  private Runnable runnable1 = new Runnable() {
    ...
    public void run() {
      //simpleExoPlayerView.setUseController(false);
      //simpleExoPlayerView.setControlShowDurationMs(5000);
      GlobalController.closeLoading();
      //handler2.postDelayed(this, 500); // agar baca JON selanjutnya setelah 5 detik
    }
  };
  ...
  public void showDialog(){
    ...
    builder.setMessage("How do you want to play?");
    builder.setNegativeButton("Restart", new DialogInterface.OnClickListener() {
      ...
      public void onClick(DialogInterface dialog, int which) {
        ...
        initializePlayer();
        isPlaying =true;
        handlerPlayControl.postDelayed(runnable1, 10000);
      }
    });
